...
export class LandlordsController {
  ...
  findOne(@Param('id', ParseUUIDPipe) id: string, @Req() req: RequestWithUser) {
    return this.landlordsService.findOne(id, req.user!);
  }
  ...
  create(
    ...
    return this.landlordsService.create(data, req.user!);
  }
  ...
  update(
    ...
    return this.landlordsService.update(id, data, req.user!);
  }
  ...
  remove(@Param('id', ParseUUIDPipe) id: string, @Req() req: RequestWithUser) {
    return this.landlordsService.remove(id, req.user!);
  }
}
