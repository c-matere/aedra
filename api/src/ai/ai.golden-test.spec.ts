...
jest
  .spyOn(AiService.prototype as any, 'initializeModels')
...
describe('AiService Golden Set (BS-03)', () => {
  ...
  beforeEach(async () => {
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            classify: jest
              .fn()
              .mockResolvedValue({ intent: 'general_inquiry', complexity: 1 }),
          },
        },
    ...
    (service as any).cacheKeyBuilder.build = jest
      .fn()
      .mockReturnValue('cache-key');
  });
