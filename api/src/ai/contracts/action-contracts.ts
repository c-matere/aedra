...
export const ROLE_ACTION_CONTRACTS: Record<string, Record<string, ActionContractV5>> = {
  TENANT: {
    [AiIntent.EMERGENCY]: {
      requiredEntities: [], 
    ...
    [AiIntent.PAYMENT_DECLARATION]: {
      ...
      completionCriteria: ['entity:tenantId:resolved', 'tool:record_payment:success'],
      fallbackOnFailure: 'clarify_tenant_identity'
    },
    [AiIntent.TENANT_COMPLAINT]: {
      requiredEntities: ['tenantId'],
      requiredTools: ['log_tenant_incident'],
      completionCriteria: ['entity:tenantId:resolved', 'tool:log_tenant_incident:success'],
      fallbackOnFailure: 'clarify_tenant_identity'
    }
  },
  COMPANY_STAFF: {
    [AiIntent.ONBOARDING]: {
      ...
      completionCriteria: ['tool:onboard_property:success', 'tool:add_tenant:success'],
    ...
    [AiIntent.FINANCIAL_QUERY]: {
      ...
      completionCriteria: ['tool:get_revenue_summary:success', 'tool:get_collection_rate:success'],
      fallbackOnFailure: 'ask_property_name'
    }
  },
  LANDLORD: {
