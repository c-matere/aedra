...
describe('Reports (e2e)', () => {
    ...
    const reportsService = {
        getSummary: jest.fn().mockResolvedValue({ properties: 2, units: 10, tenants: 5, activeLeases: 4 }),
        getOccupancy: jest.fn().mockResolvedValue({ VACANT: 3, OCCUPIED: 7, UNDER_MAINTENANCE: 0 }),
