  ...
  const messages: any[] = [
    {
      role: 'system',
      content:
        "You are Aedra, a proactive assistant. When asked to perform bulk tasks, do them all in sequence. Use ID 'prop-123' for any property you create.",
    },
    {
      role: 'user',
      content:
        "Select company 'comp-xyz', then create a property 'Antigravity Gardens' in Nairobi and add 12 units numbered T1 to T12 with rent 500 each. Just do it.",
    },
  ];
