            ...
            >
                <div className="flex items-start justify-between">
                    <div className="flex gap-3">
                        ...
                        <div>
                            <h3 className="text-sm font-bold text-[#1f1e1d]">WhatsApp Business</h3>
                            <p className="text-[10px] text-[#73726c] font-medium uppercase tracking-wider mt-0.5">Messaging Automation</p>
                        </div>
                    </div>
                    <div className={cn(
                    ...
                    <div className="p-8 space-y-6 overflow-y-auto flex-1">
                        <SlidePanelHeader className="border-b border-[#dedcd1] pb-6">
                            ...
                            <SlidePanelDescription className="text-sm text-[#73726c]">
                                Configure official Meta credentials to broadcast automated notifications.
                            </SlidePanelDescription>
                        </SlidePanelHeader>

                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-[#73726c] uppercase tracking-widest">Access Token</label>
                                <Input 
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-[#73726c] uppercase tracking-widest">Phone ID</label>
                                    <Input 
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-[#73726c] uppercase tracking-widest">Account ID</label>
                                    <Input 
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-[#73726c] uppercase tracking-widest">Webhook Verify Token</label>
                                <Input 
