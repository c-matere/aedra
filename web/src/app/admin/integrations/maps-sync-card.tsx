            ...
            >
                <div className="flex items-start justify-between">
                    <div className="flex gap-3">
                        ...
                        <div>
                            <h3 className="text-sm font-bold text-[#1f1e1d]">{company.mapProvider || "Mapbox GL"}</h3>
                            <p className="text-[10px] text-[#73726c] font-medium uppercase tracking-wider mt-0.5">Geo-Information Node</p>
                        </div>
                    </div>
                    <div className={cn(
            ...
            <SlidePanel open={isEditing} onOpenChange={setIsEditing}>
                <SlidePanelContent className="sm:max-w-2xl border-l border-[#dedcd1] bg-[#faf9f5] shadow-none flex flex-col h-full justify-between p-0">
                    <div className="p-8 space-y-6 overflow-y-auto flex-1">
                        <SlidePanelHeader className="border-b border-[#dedcd1] pb-6">
                            <SlidePanelTitle className="text-2xl font-normal font-serif text-[#141413]">
                                Configure Geospatial Engine
                            </SlidePanelTitle>
                            <SlidePanelDescription className="text-sm text-[#73726c]">
                                Connect your mapping provider to render high-fidelity maps for properties and units.
                            </SlidePanelDescription>
                        </SlidePanelHeader>

                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-[#73726c] uppercase tracking-widest">Render Provider</label>
                                <div className="h-10 bg-[#ffffff] border-[#dedcd1] rounded-[9.6px] relative px-3 flex items-center">
                                    ...
                                    >
                                        <option value="Mapbox GL">Mapbox GL</option>
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-[#73726c] uppercase tracking-widest">Access Token / API Key</label>
                                <Input 
                    ...
                    <div className="border-t border-[#dedcd1] p-6 bg-[#ffffff] flex gap-3">
                        ...
                        >
                            <Globe className="h-4 w-4 mr-2" /> Validate
                        </Button>
                        <Button 
